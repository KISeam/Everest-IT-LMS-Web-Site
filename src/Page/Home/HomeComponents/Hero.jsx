        ...
        <div className="flex-1 flex flex-col justify-between w-full">
          <div className="font-poppins">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-lg  sm:text-xl md:text-[22px] text-[#141F51] work">
                Build A Strong Career With
              </p>
            </div>
            <h1 className="text-3xl sm:text-4xl md:text-6xl 2xl:text-4xl font-semibold outfit">
              Become Learner{" "}
              <span className="text-4xl sm:text-5xl md:text-6xl 2xl:text-4xl text-[#141F51]">
                To Leader{" "}
              </span>
            </h1>
            <h1 className="md:text-6xl uppercase my-4 text-5xl  outfit">
              Start Your <span className="text-[#FFD236]">Digital Journey</span>{" "}
              Today
            </h1>
                  ...
                  <div className="stat-figure text-secondary flex-shrink-0 mr-2">
                    <div className="avatar online">
                      <div className="w-10 sm:w-12 md:w-14 rounded-full ">
                        <img
                          className="border-2 rounded-full border-[#FFD236] "
