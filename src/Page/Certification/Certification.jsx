        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="flex flex-col items-center md:items-stretch gap-6 py-4 px-6 border border-gray-200 rounded-lg shadow-md bg-white">
            <div className="flex flex-col md:flex-row justify-center items-center gap-4 w-full">
              ...
              <div className="flex items-center justify-center py-2 px-4 rounded-lg bg-[#141F51]">
              ...
              <div className="overflow-x-auto">
                {hasSearched && filteredUsers.length === 0 ? (
                  ...
                  <table className="min-w-full border-collapse border border-gray-200">
                    <thead>
                      <tr className="bg-[#141F51] text-white">
                          ...
                          <td className="border border-gray-200 px-4 py-2 text-center">
                            <div className="flex justify-center gap-2">
                              <button
                                ...
                                className="bg-[#141F51] text-white px-3 py-1 rounded hover:bg-[#67aaa6] transition cursor-pointer"
                              >
                                Visit
                              </button>
                              <button
