    ...
    <div className="bg-[#f0fdfa] py-16 px-4">
      <div className="w-10/12 mx-auto space-y-6">
        ...
        <div className="relative">
          <button
            onClick={() => scroll("left")}
            className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-[#141F51] p-2 rounded-full shadow-md  cursor-pointer"
          >
            <FaArrowLeft />
          </button>
          ...
          <button
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-[#141F51] p-2 rounded-full shadow-md cursor-pointer"
          >
            <FaArrowRight />
          </button>
        </div>
