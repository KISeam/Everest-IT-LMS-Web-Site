        ...
        <div className="flex flex-col items-center gap-6">
          <div className="shadow-lg rounded-xl bg-white overflow-hidden">
            ...
            <div className="px-6 py-4 space-y-1.5 text-gray-800">
              ...
              <button className="bg-[#141F51] rounded-md py-1.5 px-7 work tracking-tight text-[15px] text-white cursor-pointer border border-[#141F51] w-full mt-2">
                Enroll Now
              </button>
            </div>
          </div>
              ...
              >
                <div className="rounded-md border border-gray-200 bg-white p-2 text-gray-800 overflow-hidden transition-all duration-700 ease-in-out">
                  ...
                  <div className="flex justify-between items-center mt-2 pl-4 mb-2">
                    ...
                    <div className="flex gap-2 text-xl items-center border border-[#141F51] px-4 py-2 mr-6 rounded-md">
                      <IoMdCall className="text-xl text-[#141F51] font-semibold" />
