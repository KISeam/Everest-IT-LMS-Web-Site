      ...
      <div className="w-11/12 max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center justify-between gap-10">
        ...
        <div className="w-full lg:w-1/2 bg-[#e6eded] shadow-lg rounded-lg p-6 sm:p-8 md:p-10">
          ...
          <h2 className="text-lg sm:text-xl text-gray-600 text-center mt-4 sm:mt-6">
            ...
            <Link to="/register">
              <span className="text-[#141F51] font-semibold underline">
                Register
              </span>
            </Link>
          </h2>
          ...
          <div className="mt-6">
            ...
            <input
              className="w-full h-[50px] sm:h-[60px] bg-white rounded-lg outline-[#FFD236] px-4 mt-3"
              type="text"
          ...
          <div className="mt-8">
            <button className="btn w-full h-[60px] sm:h-[75px] bg-[#141F51] text-xl sm:text-2xl text-white rounded-lg border-none hover:bg-[#FFD236] hover:text-black">
              Login
            </button>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between mt-6 gap-4">
            <div className="flex items-center relative w-full">
              <RiFacebookFill
                className="text-[#141F51] absolute left-4"
                size={25}
              />
              <button className="btn w-full h-[60px] sm:h-[70px] bg-base-200 pl-12 rounded-lg text-base sm:text-xl hover:outline-2 outline-[#FFD236] border-none">
                Facebook
              </button>
            </div>
            <div className="flex items-center relative w-full">
              <FaGoogle className="text-[#141F51] absolute left-4" size={25} />
              <button className="btn  w-full h-[60px] sm:h-[70px] bg-base-200 pl-12 rounded-lg text-base sm:text-xl hover:outline-2 outline-[#FFD236] border-none">
                Google
              </button>
            </div>
